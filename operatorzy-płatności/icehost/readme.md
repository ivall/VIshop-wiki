...
!!!info Informacja
IceHost nie jest operatorem płatności, a hostingiem serwerów posiadającym integrację z itemshopem.
!!!
## Konfiguracja IceHost
...
Następnie wybieramy IceHost i nazywamy go (np. IceHost). Powinno tak to wyglądać
